...
$(window).scroll(function() {
    if (($(window).width() / $(window).height()) > 1.4469) {
        ...
        if ($(this).scrollTop() > 36) {
            ...
            if ($("#introTitle").hasClass("flipOutX")) {} else {
        ...
        if ($(this).scrollTop() > 1100) {
            ...
            console.log("Removing FadeIn");
            if ($(".aboutMeCard").hasClass("fadeOut")) {} else {
                $('.aboutMeCard').addClass('fadeOut');
                setTimeout(function() {
                    $('.aboutMeButton').addClass('fadeOut');
                }, 200);
        ...
        if ($(this).scrollTop() > 1400) {
            ...
            setTimeout(function() {
                $('#projectCard4').removeClass('fadeOut');
            }, 450);

            setTimeout(function() {
                $('#projectCard5').removeClass('fadeOut');
            }, 600);

            setTimeout(function() {
                $('#projectCard6').removeClass('fadeOut');
            }, 750);
	   ...
	   console.log("Adding flipInX");*/
		...
		setTimeout(function(){
            ...
            console.log("Removing flipInX");
            if ($("#projectCard1").hasClass("fadeOut")) {} else {
                ...
                setTimeout(function() {
                    $('#projectCard4').addClass('fadeOut');
                }, 450);
                setTimeout(function() {
                    $('#projectCard5').addClass('fadeOut');
                }, 600);
                setTimeout(function() {
                    $('#projectCard6').addClass('fadeOut');
                }, 750);
                setTimeout(function() {
